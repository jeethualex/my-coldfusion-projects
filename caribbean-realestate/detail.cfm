    ...
    <div class="w75p floatL">
      ...
      <div class="contentHolder" align="center">
        ...
        <div id="container_tabs">
          <ul class="menu_tabs">
            <li id="news" class="active">Photos (#arrayLen(photos)#)</li>
            <li id="tutorials" class="">Location Map</li>
            <li id="links" class="">Other Details</li>
          </ul>
          <span class="clear"></span>
          <div class="tab_content news" style="display: block; ">
            <!---NEW GALLERY--->
...
##container_tabs ul.menu_tabs li {
...
/*rounded tabs*/
            ...
            <table class="noborder" cellpadding="5">
              <tr>
                <td width="300"><div id="gallery" class="ad-gallery checkerLightBG" align="center">
                      ...
                      <div class="ad-thumbs">
                        <ul class="ad-thumb-list">
                          <cfloop index="i" from="1" to="#arrayLen(photos)#" step="1">
                            <li> <a href="#application.uploadPath##photos[i]#"> <img src="#application.uploadPath##photos[i]#" class="image0" width="120"> </a> </li>
                          </cfloop>
                          <!--- <li>
          ...
          <div class="tab_content tutorials" style="display: none; ">
            <style type="text/css">
...
function showMap(address) {
	...
	geocoder.geocode( { 'address': address}, function(results, status) {
		if (status == google.maps.GeocoderStatus.OK) {
          ...
          <div class="tab_content links" style="display: none; ">
            <table border="0" cellpadding="5" cellspacing="0" width="100%">
              <tr>
                <td width="55"><strong>Title</strong></td>
                <td>#qry.title#</td>
